    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/bolsoamarillo.jpg" width="50px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/morralmorado.jpg" width="50px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/canguroamarillo.jpg" width="150px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/vicakids.jpg" width="150px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/hombre.jpg" width="150px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/monederos.jpg" width="150px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/portacelular.jpg" width="150px" />
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          ...
          <img src="/minivica.jpg" width="150px" />
